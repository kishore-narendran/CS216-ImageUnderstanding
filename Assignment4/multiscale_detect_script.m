...
training_image = im2double(rgb2gray(imread('images/test3.jpg')));
...
testing_image= im2double(rgb2gray(imread('images/test3.jpg')));


% Finding n detections in the test image
number_of_detections = 6;
% [ x, y, score ] = detect(testing_image, template, number_of_detections);
[ x, y, score ] = multiscale_detect(testing_image, template, number_of_detections);
